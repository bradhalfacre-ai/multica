      ...
      entries: [
        {
          version: "0.3.16",
          date: "2026-06-04",
          title: "Lark Bot, 더 똑똑한 채팅 컨텍스트, 작업 목록",
          changes: [],
          features: [
            "에이전트의 Integrations 탭에서 Lark Bot을 연결하고 Docs에서 설정 안내를 확인할 수 있습니다.",
          ...
          improvements: [
            "Lark에서 시작된 작업은 게시글, 전달된 메시지, 인용 답글을 포함한 더 풍부한 대화 컨텍스트를 받습니다.",
            "Lark 메시지가 더 신중하게 묶여 같은 대화에서 중복 에이전트 실행이 시작될 가능성이 줄었습니다.",
