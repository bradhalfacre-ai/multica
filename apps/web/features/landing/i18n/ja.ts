      ...
      entries: [
        {
          version: "0.3.16",
          date: "2026-06-04",
          title: "Lark Bot、スマートなチャットコンテキスト、タスクリスト",
          changes: [],
          features: [
            "エージェントの Integrations タブから Lark Bot を接続でき、Docs で設定手順を確認できます。",
          ...
          improvements: [
            "Lark から始まる作業は、投稿、転送メッセージ、引用返信を含むより豊かな会話コンテキストを受け取ります。",
            "Lark メッセージのまとまり方が改善され、同じ会話から重複したエージェント実行が起きにくくなりました。",
